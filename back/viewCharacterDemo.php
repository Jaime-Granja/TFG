    ...
    <div id="stats">
      ...
      <!-- Versión antigua
        <div class="stat" id="str">
          ...
          <div id="strNum"><?php //echo $stats['strength'] + $specieTraits['ability_score']['str']; ?></div>
          <div class="mod" id="strMod"></div>
        </div>
        <div class="stat" id="dex">
          <div id="dexName">Destreza</div>
          <div id="dexNum"><?php //echo $stats['dexterity'] + $specieTraits['ability_score']['dex']; ?></div>
          <div class="mod" id="dexMod"></div>
        </div>
        <div class="stat" id="con">
          <div id="conName">Constitución</div>
          <div id="conNum"><?php //echo $stats['constitution'] + $specieTraits['ability_score']['con']; ?></div>
          <div class="mod" id="conMod"></div>
        </div>
        <div class="stat" id="int">
          <div id="intName">Inteligencia</div>
          <div id="intNum"><?php //echo $stats['intelligence'] + $specieTraits['ability_score']['int']; ?></div>
          <div class="mod" id="intMod"></div>
        </div>
        <div class="stat" id="wis">
          <div id="wisName">Sabiduría</div>
          <div id="wisNum"><?php //echo $stats['wisdom'] + $specieTraits['ability_score']['wis']; ?></div>
          <div class="mod" id="wisMod"></div>
        </div>
        <div class="stat" id="cha">
          <div id="chaName">Carisma</div>
          <div id="chaNum"><?php //echo $stats['charisma'] + $specieTraits['ability_score']['cha']; ?></div>
          <div class="mod" id="chaMod"></div>
        </div>
        -->
      <div id="globalStats">
